...
# Using Selected Features from \code{anglem_object}
# ---------------------------------------------------------------------------
...
#' selected features (genes). The function utilizes an `anglem` object to
...
#' @param anglem_object An \code{\link{anglem}} object previously generated
